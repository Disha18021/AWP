...
{
    public partial class sy7c : Page
    {
        ...
        protected void b1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // SQL Insert command
                co.CommandText = "INSERT INTO Table1(empID, empName, empCity, empSalary) VALUES(@p1, @p2, @p3, @p4);";
        ...
        protected void b2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // SQL Delete command
                co.CommandText = "DELETE FROM Table1 WHERE empID = @p1;";
                int rowsAffected = co.ExecuteNonQuery();
        ...
        protected void b3_Click(object sender, EventArgs e)
        {
            ...
            // SQL Select command
            co.CommandText = "SELECT * FROM Table1;";
            ds = co.ExecuteReader();
